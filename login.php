...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Requête pour vérifier les informations utilisateur
...
<body>
    <div class="movie-container" style="max-width: 400px; margin: auto; padding: 2rem; text-align: center;">
        ...
        <form method="POST">
            ...
            <button type="submit" style="padding: 0.5rem 1rem; background-color: #f6c90e; border: none; cursor: pointer;">connection</button>
        </form>
    </div>
</body>
</html>